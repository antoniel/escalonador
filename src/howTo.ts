import { SchedulerFactory, SchedulerMethods } from "./schedulers"
...
console.log("executando o algoritmo de escalonamento de Iprocessos FIFO, e paginacao LRU")
...
const lruPaging1: PagingAlgorithm = new LRUPageReplacement(processes, ramSize, pageSize, diskSize)
